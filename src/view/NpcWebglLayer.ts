...
export default class NpcWebglLayer implements maplibregl.CustomLayerInterface {
  ...
  private static readonly SPRITE_SHEETS = {
    idle: '/assets/sprites/brian/brian_idling_31x1.png',
    walking: '/assets/sprites/brian/brian_walking_forward_31x1.png',
    running: '/assets/sprites/brian/brian_running_forward_23x1.png'
  };
